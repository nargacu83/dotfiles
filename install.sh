...
PKG_APPS_FILE_MANAGER="gvfs gvfs-smb gvfs-mtp thunar tumbler thunar-volman thunar-archive-plugin thunar-media-tags-plugin ffmpegthumbnailer file-roller filelight"
