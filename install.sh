...
PKG_DISPLAY="xorg-server xorg-xrandr xorg-xsetroot xorg-xprop lightdm lightdm-gtk-greeter numlockx picom polkit polkit-gnome"
...
function install_dotfiles () {
    ...
    "$SCRIPT_FOLDER/root/install_root.sh"
}
